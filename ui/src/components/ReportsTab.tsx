    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-4 py-2.5 glass-light hover:bg-slate-700/50 rounded-xl transition-all duration-200 font-medium self-start disabled:opacity-70"
        >
          <RefreshCw
          ...
          {reports.map((report) => (
            ...
            >
              <button
                ...
                className="w-full px-4 sm:px-5 py-4 flex items-center justify-between hover:bg-slate-700/20 transition-colors"
              >
              ...
              {expandedId === report.id && (
                <div className="border-t border-slate-700/30 p-4 sm:p-5 bg-slate-800/30">
                  {loading === report.id ? (
